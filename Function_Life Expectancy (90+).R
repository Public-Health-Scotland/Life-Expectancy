...
## The function requires deaths and population data to grouped into 20 agebands (<1 year,1-4 years,5-9....to 90+) 

## Tokens the function expects
...
LE_90_function <- function (run_name, fp_deaths, fp_pop, fp_output, yearstart, yearend, time_agg) {
  ...
  #save out RDS for checking purposes - not always necessary
